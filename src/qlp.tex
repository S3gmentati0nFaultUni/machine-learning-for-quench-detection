...
is $0.969$ and its standard deviation is $0.015$.
\begin{table}[!ht]
	...
	\begin{tabular}{ccccc}
		...
		\\
		\midrule
		\textsc{Fold 0}         & $0$           & $4$           & $2$            & $5$            \\
		\textsc{Fold 1}         & $0$		& $2$		& $1$            & $0$		  \\
		\textsc{Fold 2}		& $1$           & $3$		& $1$            & $0$            \\
		\textsc{Fold 3}         & $0$           & $5$ 		& $2$            & $1$            \\
		\textsc{Fold 4}         & $0$		& $0$           & $1$            & $3$            \\
		\midrule
		\textsc{total errors}	& $1$		& $14$		& $7$		& $9$
		\\
		\bottomrule
	\end{tabular}
\end{table}
