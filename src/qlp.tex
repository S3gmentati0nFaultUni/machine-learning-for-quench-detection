...
which is $0.967$ and with a standard deviation of $0.051$. Testing the performance of the aggregate
...
to compare it better to alternatives. Our supposition at the moment is that finding a better model for coil $3$ would make the performance of
