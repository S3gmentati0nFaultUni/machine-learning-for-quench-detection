...
\section{SVM}
\label{sec:svm}
\comment{Check this section}{Check this section for errors or stuff that can be phrased better, the
...
Soft margin \svm is defined by substituting $0/1$ loss with hinge loss, a convex function for binary
...
\begin{equation}
	...
	\end{aligned}
\end{equation}
Since the dual problem has a structure which is very similar to the one shown in \cref{eq:dual} the
