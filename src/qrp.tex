...
\Cref{fig:best-dts} we can see a comparison of the best \dts built on every table, despite \cnmod\ being a bit closer than the rest of the pack, all of the models fail to perform quite as good as \an\ did.
\begin{figure}[t]
	\centering
