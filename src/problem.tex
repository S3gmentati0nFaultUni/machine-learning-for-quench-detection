\chapter{Overview of the experiment and development environment}
\label{chp:problem}
\todo{Modificare tutta questa sezione per fare in modo che non scimmiotti l'articolo originale}
