...
\begin{itemize}
	\item \an: the imaginary part of the magnetic field harmonics, since the magnets
	...
	\item \bn: the real part of the magnetic field harmonics, for the same reason above
	...
	\item \phin: the phase of the magnetic field harmonics, since in the original
...
\begin{table}[t]
	...
	\begin{tabular}{lccc}
		...
		\textbf{CPU}         & i$5$ $5287\textsc{u}$ & Ryzen $3700\textsc{x}$ & i$7$ $4770$        \\
...
used a combination of a parameter grid (shown in \Cref{tbl:params}) chosen by us and a grid search
algorithm (GridSearchCV in scikit-learn).
