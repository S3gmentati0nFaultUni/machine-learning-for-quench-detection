...
state.\todo{Capire perché non si sono usati più voltage taps diversi}
\begin{figure}[h!]
	\centering
...
detected using a quench antenna.\todo{Non so se ho scritto delle cazzate -- Bigi} Since the
...
a certain magnetic field, for instance a quadrupole, contain multipolar harmonics that disturb the
main component. In the context of our example, a quadrupole generates a main quadrupolar component but introduces sestupolar, ottupolar, \ldots harmonics that disturb the main field.
