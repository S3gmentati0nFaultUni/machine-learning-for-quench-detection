...
\begin{itemize}
	\item the imaginary part $A_n$ of the $n^\text{th}$ field harmonic coefficient;
	\item the real part $B_n$ of the $n^\text{th}$ field harmonic coefficient;
	\item the absolute value $|C_n|$ of the $n^\text{th}$ field harmonic coefficient;
	\item the phase $\phi_n$ of the $n^\text{th}$ field harmonic coefficient.
\end{itemize}
